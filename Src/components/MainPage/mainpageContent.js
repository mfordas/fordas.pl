...
const MainPageContent = () => {
  return (
    <div className="mainPageContainer" >
        ...
        <a href={'https://www.linkedin.com/in/mateusz-fordas/'} target='_blank' rel="noreferrer"> <b>LinkedIn</b></a></p></div>
        </div>
        <div className="contentArea">
        <div className="text"><p>Aby dowiedzieć się więcej o mnie i moich projektach odwiedź sekcję "o mnie" a także moje
        <a href={'https://fordas.pl/Portfolio/index'} target='_blank' rel="noreferrer"> <b>portfolio</b></a></p></div>
